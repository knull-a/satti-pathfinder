      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">
            ...
            <span className="bg-gradient-primary bg-clip-text text-transparent"> своей отрасли</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Получите доступ к талантливой молодежи, формируйте профессиональную культуру и создавайте кадровый резерв для долгосрочного успеха компании
          </p>
        </div>
